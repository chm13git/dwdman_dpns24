...
case ${DIR} in
   ...
   dirdpns42="admbackup@10.13.100.42:/data2/backup/backup_icon/bkp_input_icondata_ant"
   filename="iconant_"
   filename2="iconant_"
   cp ${dirdpns24}/i* /home/dwdman/backup/icondata/antartica/
   ;;
   icondata_met5)

   dirdpns24="/home/dwdman/gmedata/data${HH}"
   dirdpns24_bkp="/home/dwdman/backup/icondata/metarea5"
   dirdpns42="admbackup@10.13.100.42:/data2/backup/backup_icon/bkp_input_icondata_met5"
   filename="iconmet_"
   filename2="iconmet_"
   cp ${dirdpns24}/i* /home/dwdman/backup/icondata/metarea5/
   ;;
esac
...
echo
    rsync -av --ignore-existing ${dirdpns24_bkp}/*.tar.bz2 ${dirdpns42}/
echo
